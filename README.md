...
* [dj-control-room](https://github.com/django-control-room/dj-control-room) ⭐ 564 | 🐛 16 | 🌐 Python | 📅 2026-08-11 - Build a control plane with a suite of operational tools inside the Django admin (Redis, cache, Celery, URLs, and more).
...
* [django-grappelli](https://github.com/sehmaschine/django-grappelli) ⭐ 3,943 | 🐛 8 | 🌐 HTML | 📅 2026-08-10 - A jazzy skin for the admin.
* [django-unfold](https://github.com/unfoldadmin/django-unfold) ⭐ 3,639 | 🐛 27 | 🌐 Python | 📅 2026-08-25 - Modern Django admin theme for seamless interface development.
...
* [django-daisy](https://github.com/hypy13/django-daisy) ⭐ 364 | 🐛 14 | 🌐 CSS | 📅 2026-08-25 - A modern django dashboard fully responsive built with daisyui.
...
* [django-smartbase-admin](https://github.com/SmartBase-SK/django-smartbase-admin) ⭐ 127 | 🐛 2 | 🌐 Python | 📅 2026-08-25 - Django SmartBase Admin 🚀 performance-tuned 👥 end-user ready beautiful admin panel

### APIs

<!--lint disable double-link-->

* [django-rest-framework](https://github.com/encode/django-rest-framework) ⭐ 30,144 | 🐛 57 | 🌐 Python | 📅 2026-08-25 - Web APIs for Django.
...
* [djoser](https://github.com/sunscrapers/djoser) ⭐ 2,681 | 🐛 200 | 🌐 Python | 📅 2026-08-01 - REST implementation of Django auth.
...
* [django-modern-rest](https://github.com/wemake-services/django-modern-rest) ⭐ 1,366 | 🐛 20 | 🌐 Python | 📅 2026-08-26 - Modern REST with speed, types, async, `msgspec`, `pydantic` and other goodies!
* [django-rest-knox](https://github.com/jazzband/django-rest-knox) ⭐ 1,259 | 🐛 36 | 🌐 Python | 📅 2026-08-24 - Authentication Module for django-rest-auth.
...
* [django-extensions](https://github.com/django-extensions/django-extensions/) ⭐ 6,813 | 🐛 219 | 🌐 Python | 📅 2026-05-21 - Custom management extensions, notably `runserver_plus` and `shell_plus`.
...
* [django-migration-zero](https://github.com/ambient-innovation/django-migration-zero/) ⭐ 85 | 🐛 0 | 🌐 Python | 📅 2026-07-03 - Holistic implementation of "migration zero" pattern for Django covering local changes and in-production database adjustments.
...
* [environs](https://github.com/sloria/environs) ⭐ 1,373 | 🐛 3 | 🌐 Python | 📅 2026-08-25 - Simplified environment variable parsing that comes with a [Django helper](https://github.com/sloria/environs#usage-with-django) ⭐ 1,373 | 🐛 3 | 🌐 Python | 📅 2026-08-25 that installs additional packages.
...
* [wagtail](https://github.com/wagtail/wagtail) ⭐ 20,451 | 🐛 1,015 | 🌐 Python | 📅 2026-08-25 - Popular Django content management system (CMS). See [awesome-wagtail](https://github.com/wagtail/awesome-wagtail) ⭐ 2,188 | 🐛 0 | 🌐 Python | 📅 2026-06-16 too.
* [django-cms](https://github.com/django-cms/django-cms) ⭐ 10,663 | 🐛 14 | 🌐 Python | 📅 2026-08-25 - CMS for Django.
* [mezzanine](https://github.com/stephenmcd/mezzanine) ⭐ 4,822 | 🐛 65 | 🌐 Python | 📅 2026-04-19 - CMS framework.
* [feincms](https://github.com/feincms/feincms) ⭐ 1,119 | 🐛 25 | 🌐 Python | 📅 2026-08-24 - An extensible Django-based CMS.
...
* [Wireup](https://github.com/maldoinc/wireup) ⭐ 431 | 🐛 20 | 🌐 Python | 📅 2026-08-16 - Dependency Injection for Django

### ECommerce

* [saleor](https://github.com/saleor/saleor) ⭐ 23,265 | 🐛 248 | 🌐 Python | 📅 2026-08-26 - GraphQL-based Django E-Commerce Platform.
...
* [django-tinymce](https://github.com/jazzband/django-tinymce) ⭐ 1,354 | 🐛 43 | 🌐 JavaScript | 📅 2026-08-17 - TinyMCE integration for Django.
...
* [django-imagekit](https://github.com/matthewwithanm/django-imagekit) ⭐ 2,349 | 🐛 92 | 🌐 Python | 📅 2026-07-12 - Django app for processing images for thumbnail, black-and-white and sizes.
...
* [django-crispy-forms](https://github.com/django-crispy-forms/django-crispy-forms/) ⭐ 5,159 | 🐛 75 | 🌐 Python | 📅 2026-07-29 - DRY Django forms.
...
* [Django LiveView](https://github.com/Django-LiveView/liveview) ⭐ 255 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-15 - Framework for creating dynamic, reactive interfaces server-side with Django templates. Real-time updates via WebSocket with decorator-based handlers.
...
* [Weblate](https://github.com/WeblateOrg/weblate) ⭐ 6,038 | 🐛 499 | 🌐 Python | 📅 2026-08-26 - Weblate is a copylefted libre software web-based continuous localization system, used by over 2500 libre projects and companies in more than 165 countries.
...
* [django-tables2](https://github.com/jieter/django-tables2) ⭐ 2,010 | 🐛 110 | 🌐 Python | 📅 2026-07-20 - HTML tables with pagination/sorting.
...
* [django-prometheus](https://github.com/django-commons/django-prometheus) ⭐ 1,665 | 🐛 100 | 🌐 Python | 📅 2026-07-30 - Export Django monitoring metrics to Prometheus.
...
* [django-model-utils](https://github.com/jazzband/django-model-utils) ⭐ 2,762 | 🐛 124 | 🌐 Python | 📅 2026-08-17 - Django model mixins and utilities.
...
* [django-taggit](https://github.com/jazzband/django-taggit/) ⭐ 3,445 | 🐛 113 | 🌐 Python | 📅 2026-08-24 - Simple model tags.
...
* [django-treenode](https://github.com/fabiocaccamo/django-treenode) ⭐ 803 | 🐛 5 | 🌐 Python | 📅 2026-08-26 - Abstract model/admin for tree-based stuff.
...
* [pyinstrument](https://github.com/joerick/pyinstrument) ⭐ 8,006 | 🐛 26 | 🌐 Python | 📅 2026-08-04 - Call stack profiler for Python, Django, Flask, FastAPI.
* [django-silk](https://github.com/jazzband/django-silk) ⭐ 4,991 | 🐛 126 | 🌐 Python | 📅 2026-08-26 - Live profiling and inspection of HTTP requests and database queries.
...
* [django-csp](https://github.com/mozilla/django-csp) ⭐ 625 | 🐛 11 | 🌐 Python | 📅 2025-11-14 - Adds [Content-Security-Policy](http://www.w3.org/TR/CSP/) headers to Django.
...
* [django-storages](https://github.com/jschneier/django-storages) ⭐ 2,956 | 🐛 182 | 🌐 Python | 📅 2026-08-02 - A single library to support multiple custom storage backends for Django.
* [django-compressor](https://github.com/django-compressor/django-compressor/) ⭐ 2,870 | 🐛 121 | 🌐 Python | 📅 2026-08-25 - Compress JavaScript/CSS into a single cached file.
...
* [celery](https://github.com/celery/celery) ⭐ 28,827 | 🐛 798 | 🌐 Python | 📅 2026-08-24 - Robust and broker-agnostic task queues for bigger, performance-focused projects.
* [flower](https://github.com/mher/flower) ⭐ 7,235 | 🐛 156 | 🌐 Python | 📅 2026-08-16 - Flower is a web-based tool for monitoring and administrating Celery clusters.
* [huey](https://github.com/coleifer/huey) ⭐ 6,012 | 🐛 0 | 🌐 Python | 📅 2026-08-16 - A little task queue for Python, with Django support including the new `django.tasks` API.
* [django-redis](https://github.com/jazzband/django-redis) ⭐ 3,081 | 🐛 77 | 🌐 Python | 📅 2026-08-24 - Full-featured Redis cache backend for Django.
* [django-rq](https://github.com/rq/django-rq) ⭐ 1,951 | 🐛 116 | 🌐 Python | 📅 2026-08-24 - Integration for Redis Queue.
...
* [django-debug-toolbar](https://github.com/django-commons/django-debug-toolbar/) ⭐ 8,379 | 🐛 83 | 🌐 Python | 📅 2026-08-25 - Configurable panels to debug requests/responses.
* [factory-boy](https://github.com/FactoryBoy/factory_boy) ⭐ 3,804 | 🐛 210 | 🌐 Python | 📅 2026-01-01 - Test fixtures replacement.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,544 | 🐛 185 | 🌐 Python | 📅 2026-08-10 - Use pytest features in Django.
...
* [Ruff](https://github.com/astral-sh/ruff) ⭐ 49,326 | 🐛 2,147 | 🌐 Rust | 📅 2026-08-26 - An extremely fast Python linter and code formatter, written in Rust.
* [black](https://github.com/psf/black) ⭐ 41,814 | 🐛 303 | 🌐 Python | 📅 2026-08-20 - Uncompromising Python code formatter.
* [faker](https://github.com/joke2k/faker) ⭐ 19,381 | 🐛 33 | 🌐 Python | 📅 2026-08-21 - Faker is a Python package that generates fake data for you.
* [pytest](https://github.com/pytest-dev/pytest/) ⭐ 14,444 | 🐛 807 | 🌐 Python | 📅 2026-08-25 - Testing framework.
* [pillow](https://github.com/python-pillow/Pillow) ⭐ 13,776 | 🐛 167 | 🌐 Python | 📅 2026-08-26 - Python Imaging Library.
* [python-socketio](https://github.com/miguelgrinberg/python-socketio) ⭐ 4,368 | 🐛 14 | 🌐 Python | 📅 2026-08-09 - Python implementation of the Socket.IO\_ realtime client and server. [(create Socket.io Django server instance)](https://python-socketio.readthedocs.io/en/latest/server.html?highlight=django#creating-a-server-instance)
* [coveragepy](https://github.com/coveragepy/coveragepy) ⭐ 3,406 | 🐛 306 | 🌐 Python | 📅 2026-08-25 - Code coverage measurement.
...
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,202 | 🐛 431 | 🌐 Python | 📅 2026-08-26 - Error reporting SDK.
* [python-slugify](https://github.com/un33k/python-slugify) ⭐ 1,623 | 🐛 17 | 🌐 Python | 📅 2026-04-27 - Returns unicode slugs.
...
* [Source Code](https://github.com/django/django/) ⭐ 88,964 | 🐛 473 | 🌐 Python | 📅 2026-08-23 - Hosted on GitHub.
...
* [Django Styleguide](https://github.com/HackSoftware/Django-Styleguide) ⭐ 6,281 | 🐛 5 | 🌐 Python | 📅 2025-09-25 - Styleguide for Django with best practices and examples.
...
* [Piku](https://github.com/piku/piku) ⭐ 6,604 | 🐛 5 | 🌐 Python | 📅 2026-08-10
...
* [cookiecutter-django](https://github.com/cookiecutter/cookiecutter-django/) ⭐ 13,603 | 🐛 111 | 🌐 Python | 📅 2026-08-25 - A full-bodied starter project, highly customizable.
...
* [PostHog](https://github.com/PostHog/posthog) ⭐ 39,194 | 🐛 5,036 | 🌐 Python | 📅 2026-08-26 - Open-source product analytics.
* [Zulip](https://github.com/zulip/zulip/) ⭐ 25,772 | 🐛 2,047 | 🌐 Python | 📅 2026-08-25 - Open-source team chat.
* [linkding](https://github.com/sissbruecker/linkding) ⭐ 11,101 | 🐛 197 | 🌐 Python | 📅 2026-08-18 - Self-hosted bookmark manager that is designed to be minimal, fast, and easy to set up using Docker.
* [Healthchecks](https://github.com/healthchecks/healthchecks) ⭐ 10,287 | 🐛 53 | 🌐 Python | 📅 2026-08-21 - A Cron Monitoring Tool written in Python & Django.
* [Flagsmith](https://github.com/Flagsmith/flagsmith) ⭐ 6,529 | 🐛 705 | 🌐 Python | 📅 2026-08-26 - Open-source Feature Flagging, Remote Config, and AB testing.
* [Baserow](https://github.com/baserow/baserow) ⭐ 5,710 | 🐛 1,227 | 🌐 Python | 📅 2026-08-25 - Open source no-code database and Airtable alternative built with Django and Vue.js.
* [Bootcamp: An enterprise social network](https://github.com/vitorfs/bootcamp) ⭐ 2,301 | 🐛 25 | 🌐 CSS | 📅 2023-10-01
* [OpenContracts](https://github.com/Open-Source-Legal/OpenContracts) ⭐ 1,449 | 🐛 21 | 🌐 Python | 📅 2026-08-24 - Enterprise-grade document analytics platform that combines automated PDF parsing, vector embeddings, and LLM integration.
* [Blog app with users and forms](https://github.com/wsvincent/djangoforbeginners/tree/master/ch7-blog-app-with-users/) ⭐ 1,387 | 🐛 3 | 🌐 JavaScript | 📅 2025-03-22
* [Newspaper app with custom user model, full user auth](https://github.com/wsvincent/djangoforbeginners/tree/master/ch15-comments) ⭐ 1,387 | 🐛 3 | 🌐 JavaScript | 📅 2025-03-22
...
* [Django CRM Admin](https://github.com/DjangoCRM/django-crm) ⭐ 616 | 🐛 5 | 🌐 Python | 📅 2026-08-25 - Open source Python CRM built entirely on Django Admin Site.
...
* [DRF Source Code](https://github.com/encode/django-rest-framework) ⭐ 30,144 | 🐛 57 | 🌐 Python | 📅 2026-08-25
...
* [Wagtail Source Code](https://github.com/wagtail/wagtail/) ⭐ 20,451 | 🐛 1,015 | 🌐 Python | 📅 2026-08-25
