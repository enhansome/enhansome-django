...
* [django-unfold](https://github.com/unfoldadmin/django-unfold) ⭐ 3,645 | 🐛 29 | 🌐 Python | 📅 2026-08-29 - Modern Django admin theme for seamless interface development.
...
* [django-rest-framework](https://github.com/encode/django-rest-framework) ⭐ 30,151 | 🐛 57 | 🌐 Python | 📅 2026-08-25 - Web APIs for Django.
...
* [drf-yasg](https://github.com/axnsan12/drf-yasg) ⭐ 3,545 | 🐛 242 | 🌐 Python | 📅 2026-08-29 - Automated generation of real Swagger/OpenAPI 2.0 schemas from Django REST Framework code.
...
* [django-modern-rest](https://github.com/wemake-services/django-modern-rest) ⭐ 1,383 | 🐛 21 | 🌐 Python | 📅 2026-08-29 - Modern REST with speed, types, async, `msgspec`, `pydantic` and other goodies!
...
* [channels](https://github.com/django/channels/) ⭐ 6,351 | 🐛 123 | 🌐 Python | 📅 2026-08-06 - Async support for Django.
...
* [django-environ](https://github.com/joke2k/django-environ) ⭐ 3,164 | 🐛 65 | 🌐 Python | 📅 2026-08-26 - Environment variables.
...
* [environs](https://github.com/sloria/environs) ⭐ 1,373 | 🐛 6 | 🌐 Python | 📅 2026-08-25 - Simplified environment variable parsing that comes with a [Django helper](https://github.com/sloria/environs#usage-with-django) ⭐ 1,373 | 🐛 6 | 🌐 Python | 📅 2026-08-25 that installs additional packages.
...
* [wagtail](https://github.com/wagtail/wagtail) ⭐ 20,467 | 🐛 1,013 | 🌐 Python | 📅 2026-08-29 - Popular Django content management system (CMS). See [awesome-wagtail](https://github.com/wagtail/awesome-wagtail) ⭐ 2,188 | 🐛 0 | 🌐 Python | 📅 2026-06-16 too.
...
* [saleor](https://github.com/saleor/saleor) ⭐ 23,277 | 🐛 245 | 🌐 Python | 📅 2026-08-28 - GraphQL-based Django E-Commerce Platform.
...
* [Weblate](https://github.com/WeblateOrg/weblate) ⭐ 6,043 | 🐛 501 | 🌐 Python | 📅 2026-08-29 - Weblate is a copylefted libre software web-based continuous localization system, used by over 2500 libre projects and companies in more than 165 countries.
...
* [django-tables2](https://github.com/jieter/django-tables2) ⭐ 2,010 | 🐛 107 | 🌐 Python | 📅 2026-08-29 - HTML tables with pagination/sorting.
...
* [django-anymail](https://github.com/anymail/django-anymail) ⭐ 1,899 | 🐛 16 | 🌐 Python | 📅 2026-07-30 - Django email backends and webhooks for Amazon SES, Brevo (Sendinblue), MailerSend, Mailgun, Mailjet, Postmark, Postal, Resend, SendGrid, SparkPost, Unisender Go and more.
...
* [py-spy](https://github.com/benfred/py-spy) ⭐ 15,456 | 🐛 238 | 🌐 Rust | 📅 2026-08-14 - Sampling profiler for Python programs.
...
* [celery](https://github.com/celery/celery) ⭐ 28,836 | 🐛 759 | 🌐 Python | 📅 2026-08-29 - Robust and broker-agnostic task queues for bigger, performance-focused projects.
...
* [django-debug-toolbar](https://github.com/django-commons/django-debug-toolbar/) ⭐ 8,378 | 🐛 81 | 🌐 Python | 📅 2026-08-29 - Configurable panels to debug requests/responses.
* [factory-boy](https://github.com/FactoryBoy/factory_boy) ⭐ 3,805 | 🐛 210 | 🌐 Python | 📅 2026-01-01 - Test fixtures replacement.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,545 | 🐛 185 | 🌐 Python | 📅 2026-08-10 - Use pytest features in Django.
...
* [Ruff](https://github.com/astral-sh/ruff) ⭐ 49,380 | 🐛 2,148 | 🌐 Rust | 📅 2026-08-29 - An extremely fast Python linter and code formatter, written in Rust.
* [black](https://github.com/psf/black) ⭐ 41,820 | 🐛 304 | 🌐 Python | 📅 2026-08-20 - Uncompromising Python code formatter.
...
* [pytest](https://github.com/pytest-dev/pytest/) ⭐ 14,460 | 🐛 807 | 🌐 Python | 📅 2026-08-27 - Testing framework.
* [pillow](https://github.com/python-pillow/Pillow) ⭐ 13,783 | 🐛 174 | 🌐 Python | 📅 2026-08-29 - Python Imaging Library.
...
* [coveragepy](https://github.com/coveragepy/coveragepy) ⭐ 3,407 | 🐛 307 | 🌐 Python | 📅 2026-08-28 - Code coverage measurement.
...
* [Source Code](https://github.com/django/django/) ⭐ 89,030 | 🐛 480 | 🌐 Python | 📅 2026-08-27 - Hosted on GitHub.
...
* [cookiecutter-django](https://github.com/cookiecutter/cookiecutter-django/) ⭐ 13,602 | 🐛 113 | 🌐 Python | 📅 2026-08-29 - A full-bodied starter project, highly customizable.
...
* [django-base-site](https://github.com/epicserve/django-base-site/) ⭐ 451 | 🐛 5 | 🌐 Python | 📅 2026-08-29 - A Django site with many common third-party packages pre-installed.
...
* [PostHog](https://github.com/PostHog/posthog) ⭐ 39,452 | 🐛 5,164 | 🌐 Python | 📅 2026-08-29 - Open-source product analytics.
* [Zulip](https://github.com/zulip/zulip/) ⭐ 25,786 | 🐛 2,051 | 🌐 Python | 📅 2026-08-28 - Open-source team chat.
* [linkding](https://github.com/sissbruecker/linkding) ⭐ 11,115 | 🐛 198 | 🌐 Python | 📅 2026-08-18 - Self-hosted bookmark manager that is designed to be minimal, fast, and easy to set up using Docker.
...
* [Flagsmith](https://github.com/Flagsmith/flagsmith) ⭐ 6,533 | 🐛 701 | 🌐 Python | 📅 2026-08-29 - Open-source Feature Flagging, Remote Config, and AB testing.
* [Baserow](https://github.com/baserow/baserow) ⭐ 5,744 | 🐛 1,219 | 🌐 Python | 📅 2026-08-28 - Open source no-code database and Airtable alternative built with Django and Vue.js.
* [Bootcamp: An enterprise social network](https://github.com/vitorfs/bootcamp) ⭐ 2,302 | 🐛 25 | 🌐 CSS | 📅 2023-10-01
* [OpenContracts](https://github.com/Open-Source-Legal/OpenContracts) ⭐ 1,456 | 🐛 22 | 🌐 Python | 📅 2026-08-28 - Enterprise-grade document analytics platform that combines automated PDF parsing, vector embeddings, and LLM integration.
...
* [Django CRM Admin](https://github.com/DjangoCRM/django-crm) ⭐ 617 | 🐛 5 | 🌐 Python | 📅 2026-08-26 - Open source Python CRM built entirely on Django Admin Site.
...
* [DRF Source Code](https://github.com/encode/django-rest-framework) ⭐ 30,151 | 🐛 57 | 🌐 Python | 📅 2026-08-25
...
* [Wagtail Source Code](https://github.com/wagtail/wagtail/) ⭐ 20,467 | 🐛 1,013 | 🌐 Python | 📅 2026-08-29
