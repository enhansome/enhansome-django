...
* [django-hijack](https://github.com/django-hijack/django-hijack) ⭐ 1,745 | 🐛 7 | 🌐 Python | 📅 2026-08-31 - Admins can log in and work on behalf of other users without having to know their credentials.
...
* [django-unfold](https://github.com/unfoldadmin/django-unfold) ⭐ 3,648 | 🐛 30 | 🌐 Python | 📅 2026-08-29 - Modern Django admin theme for seamless interface development.
* [django-admin-interface](https://github.com/fabiocaccamo/django-admin-interface) ⭐ 2,041 | 🐛 21 | 🌐 Python | 📅 2026-09-01 - Customize Admin by the admin itself(color, header. title,logo) and  popup windows replaced by modals.
...
* [django-smartbase-admin](https://github.com/SmartBase-SK/django-smartbase-admin) ⭐ 128 | 🐛 3 | 🌐 Python | 📅 2026-09-01 - Django SmartBase Admin 🚀 performance-tuned 👥 end-user ready beautiful admin panel

### APIs

<!--lint disable double-link-->

* [django-rest-framework](https://github.com/encode/django-rest-framework) ⭐ 30,152 | 🐛 58 | 🌐 Python | 📅 2026-09-01 - Web APIs for Django.
...
* [drf-spectacular](https://github.com/tfranzel/drf-spectacular) ⭐ 2,859 | 🐛 204 | 🌐 Python | 📅 2026-08-21 - Sane and flexible OpenAPI 3 schema generation for Django REST framework.
...
* [django-modern-rest](https://github.com/wemake-services/django-modern-rest) ⭐ 1,401 | 🐛 45 | 🌐 Python | 📅 2026-09-01 - Modern REST with speed, types, async, `msgspec`, `pydantic` and other goodies!
...
* [strawberry-django](https://github.com/strawberry-graphql/strawberry-django) ⭐ 503 | 🐛 95 | 🌐 Python | 📅 2026-09-01 - Django integration with Strawberry, a GraphQL library designed for modern development
...
* [environs](https://github.com/sloria/environs) ⭐ 1,372 | 🐛 4 | 🌐 Python | 📅 2026-09-01 - Simplified environment variable parsing that comes with a [Django helper](https://github.com/sloria/environs#usage-with-django) ⭐ 1,372 | 🐛 4 | 🌐 Python | 📅 2026-09-01 that installs additional packages.
...
* [django-extra-settings](https://github.com/fabiocaccamo/django-extra-settings) ⭐ 618 | 🐛 14 | 🌐 Python | 📅 2026-09-01 - Config and manage typed extra settings using just the django admin.
...
* [wagtail](https://github.com/wagtail/wagtail) ⭐ 20,474 | 🐛 1,014 | 🌐 Python | 📅 2026-09-01 - Popular Django content management system (CMS). See [awesome-wagtail](https://github.com/wagtail/awesome-wagtail) ⭐ 2,188 | 🐛 1 | 🌐 Python | 📅 2026-06-16 too.
* [django-cms](https://github.com/django-cms/django-cms) ⭐ 10,670 | 🐛 14 | 🌐 Python | 📅 2026-08-31 - CMS for Django.
...
* [saleor](https://github.com/saleor/saleor) ⭐ 23,282 | 🐛 245 | 🌐 Python | 📅 2026-09-01 - GraphQL-based Django E-Commerce Platform.
...
* [ReactPy](https://github.com/reactive-python/reactpy) ⭐ 8,154 | 🐛 51 | 🌐 Python | 📅 2026-07-14 - It's React, but in Python. Insert dynamically rendered Python into Django templates using the [ReactPy-Django module](https://github.com/reactive-python/reactpy-django) ⭐ 358 | 🐛 16 | 🌐 Python | 📅 2026-07-21.
...
* [Weblate](https://github.com/WeblateOrg/weblate) ⭐ 6,047 | 🐛 495 | 🌐 Python | 📅 2026-09-01 - Weblate is a copylefted libre software web-based continuous localization system, used by over 2500 libre projects and companies in more than 165 countries.
...
* [django-maintenance-mode](https://github.com/fabiocaccamo/django-maintenance-mode) ⭐ 527 | 🐛 5 | 🌐 Python | 📅 2026-09-01 - Shows a 503 error page when maintenance-mode is on.
...
* [django-freeze](https://github.com/fabiocaccamo/django-freeze) ⭐ 130 | 🐛 3 | 🌐 Python | 📅 2026-08-31 - Convert your dynamic django site to a static one with one line of code.
...
* [django-modeltranslations](https://github.com/deschler/django-modeltranslation) ⭐ 1,482 | 🐛 130 | 🌐 Python | 📅 2026-04-14 -  Translates Django models using a registration approach.
...
* [django-colorfield](https://github.com/fabiocaccamo/django-colorfield) ⭐ 660 | 🐛 10 | 🌐 Python | 📅 2026-09-01 - Color field for django models with a nice color-picker widget.
...
* [django-simple-history](https://github.com/django-commons/django-simple-history) ⭐ 2,463 | 🐛 194 | 🌐 Python | 📅 2026-08-31 - Store model history and view/revert changes from the admin.
* [django-polymorphic](https://github.com/django-commons/django-polymorphic) ⭐ 1,834 | 🐛 26 | 🌐 Python | 📅 2026-08-17 - Django-polymorphic simplifies using inherited models in Django projects.
...
* [django-treenode](https://github.com/fabiocaccamo/django-treenode) ⭐ 803 | 🐛 12 | 🌐 Python | 📅 2026-09-01 - Abstract model/admin for tree-based stuff.
...
* [py-spy](https://github.com/benfred/py-spy) ⭐ 15,463 | 🐛 239 | 🌐 Rust | 📅 2026-08-14 - Sampling profiler for Python programs.
* [pyinstrument](https://github.com/joerick/pyinstrument) ⭐ 8,007 | 🐛 27 | 🌐 Python | 📅 2026-08-04 - Call stack profiler for Python, Django, Flask, FastAPI.
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,911 | 🐛 34 | 🌐 Python | 📅 2026-09-01 - Per object permissions in Django.
...
* [celery](https://github.com/celery/celery) ⭐ 28,848 | 🐛 747 | 🌐 Python | 📅 2026-09-01 - Robust and broker-agnostic task queues for bigger, performance-focused projects.
...
* [huey](https://github.com/coleifer/huey) ⭐ 6,023 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - A little task queue for Python, with Django support including the new `django.tasks` API.
* [django-redis](https://github.com/jazzband/django-redis) ⭐ 3,082 | 🐛 78 | 🌐 Python | 📅 2026-08-31 - Full-featured Redis cache backend for Django.
* [django-rq](https://github.com/rq/django-rq) ⭐ 1,951 | 🐛 114 | 🌐 Python | 📅 2026-08-30 - Integration for Redis Queue.
* [django-celery-beat](https://github.com/celery/django-celery-beat) ⭐ 1,950 | 🐛 154 | 🌐 Python | 📅 2026-08-31 - A periodic task scheduler with database configured by Django's Admin Panel.
...
* [django-q2](https://github.com/django-q2/django-q2) ⭐ 626 | 🐛 92 | 🌐 Python | 📅 2026-08-26 - A multiprocessing distributed task queue for Django.
...
* [django-components](https://github.com/django-components/django-components/) ⭐ 1,517 | 🐛 35 | 🌐 Python | 📅 2026-08-31 - A way to create simple reusable template components in Django.
...
* [django-waffle](https://github.com/django-waffle/django-waffle) ⭐ 1,258 | 🐛 59 | 🌐 Python | 📅 2026-06-07 - A feature flipper for Django.
...
* [django-redirects](https://github.com/fabiocaccamo/django-redirects) ⭐ 79 | 🐛 4 | 🌐 Python | 📅 2026-09-01 - Redirects as they should be, with full control.
...
* [Ruff](https://github.com/astral-sh/ruff) ⭐ 49,426 | 🐛 2,163 | 🌐 Rust | 📅 2026-09-01 - An extremely fast Python linter and code formatter, written in Rust.
* [black](https://github.com/psf/black) ⭐ 41,828 | 🐛 314 | 🌐 Python | 📅 2026-09-01 - Uncompromising Python code formatter.
...
* [pytest](https://github.com/pytest-dev/pytest/) ⭐ 14,465 | 🐛 806 | 🌐 Python | 📅 2026-09-01 - Testing framework.
* [pillow](https://github.com/python-pillow/Pillow) ⭐ 13,794 | 🐛 173 | 🌐 Python | 📅 2026-09-01 - Python Imaging Library.
...
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,202 | 🐛 405 | 🌐 Python | 📅 2026-09-01 - Error reporting SDK.
...
* [Source Code](https://github.com/django/django/) ⭐ 89,564 | 🐛 483 | 🌐 Python | 📅 2026-08-31 - Hosted on GitHub.
...
* [cookiecutter-django](https://github.com/cookiecutter/cookiecutter-django/) ⭐ 13,605 | 🐛 99 | 🌐 Python | 📅 2026-09-01 - A full-bodied starter project, highly customizable.
...
* [PostHog](https://github.com/PostHog/posthog) ⭐ 39,518 | 🐛 5,365 | 🌐 Python | 📅 2026-09-01 - Open-source product analytics.
* [Zulip](https://github.com/zulip/zulip/) ⭐ 25,801 | 🐛 2,054 | 🌐 Python | 📅 2026-09-01 - Open-source team chat.
* [linkding](https://github.com/sissbruecker/linkding) ⭐ 11,128 | 🐛 202 | 🌐 Python | 📅 2026-08-18 - Self-hosted bookmark manager that is designed to be minimal, fast, and easy to set up using Docker.
* [Healthchecks](https://github.com/healthchecks/healthchecks) ⭐ 10,296 | 🐛 55 | 🌐 Python | 📅 2026-08-31 - A Cron Monitoring Tool written in Python & Django.
* [Flagsmith](https://github.com/Flagsmith/flagsmith) ⭐ 6,536 | 🐛 703 | 🌐 Python | 📅 2026-09-01 - Open-source Feature Flagging, Remote Config, and AB testing.
* [Baserow](https://github.com/baserow/baserow) ⭐ 5,761 | 🐛 1,226 | 🌐 Python | 📅 2026-09-01 - Open source no-code database and Airtable alternative built with Django and Vue.js.
* [Bootcamp: An enterprise social network](https://github.com/vitorfs/bootcamp) ⭐ 2,302 | 🐛 25 | 🌐 CSS | 📅 2023-10-01
* [OpenContracts](https://github.com/Open-Source-Legal/OpenContracts) ⭐ 1,459 | 🐛 17 | 🌐 Python | 📅 2026-09-01 - Enterprise-grade document analytics platform that combines automated PDF parsing, vector embeddings, and LLM integration.
...
* [DRF Source Code](https://github.com/encode/django-rest-framework) ⭐ 30,152 | 🐛 58 | 🌐 Python | 📅 2026-09-01
...
* [Wagtail Source Code](https://github.com/wagtail/wagtail/) ⭐ 20,474 | 🐛 1,014 | 🌐 Python | 📅 2026-09-01
