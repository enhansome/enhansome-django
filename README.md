...
* [dj-control-room](https://github.com/django-control-room/dj-control-room) ⭐ 567 | 🐛 16 | 🌐 Python | 📅 2026-09-09 - Build a control plane with a suite of operational tools inside the Django admin (Redis, cache, Celery, URLs, and more).
...
* [django-unfold](https://github.com/unfoldadmin/django-unfold) ⭐ 3,671 | 🐛 28 | 🌐 Python | 📅 2026-09-10 - Modern Django admin theme for seamless interface development.
...
* [django-smartbase-admin](https://github.com/SmartBase-SK/django-smartbase-admin) ⭐ 128 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - Django SmartBase Admin 🚀 performance-tuned 👥 end-user ready beautiful admin panel

### APIs

<!--lint disable double-link-->

* [django-rest-framework](https://github.com/encode/django-rest-framework) ⭐ 30,172 | 🐛 51 | 🌐 Python | 📅 2026-09-09 - Web APIs for Django.
...
* [django-modern-rest](https://github.com/wemake-services/django-modern-rest) ⭐ 1,443 | 🐛 27 | 🌐 Python | 📅 2026-09-10 - Modern REST with speed, types, async, `msgspec`, `pydantic` and other goodies!
...
* [django-dbbackup](https://github.com/Archmonger/django-dbbackup) ⭐ 1,112 | 🐛 9 | 🌐 Python | 📅 2026-09-10 - Management commands to help backup and restore your project database and media files.
...
* [django-extra-settings](https://github.com/fabiocaccamo/django-extra-settings) ⭐ 620 | 🐛 10 | 🌐 Python | 📅 2026-09-02 - Config and manage typed extra settings using just the django admin.
...
* [wagtail](https://github.com/wagtail/wagtail) ⭐ 20,492 | 🐛 1,007 | 🌐 Python | 📅 2026-09-10 - Popular Django content management system (CMS). See [awesome-wagtail](https://github.com/wagtail/awesome-wagtail) ⭐ 2,189 | 🐛 1 | 🌐 Python | 📅 2026-06-16 too.
* [django-cms](https://github.com/django-cms/django-cms) ⭐ 10,669 | 🐛 6 | 🌐 Python | 📅 2026-09-10 - CMS for Django.
...
* [saleor](https://github.com/saleor/saleor) ⭐ 23,313 | 🐛 261 | 🌐 Python | 📅 2026-09-10 - GraphQL-based Django E-Commerce Platform.
* [django-oscar](https://github.com/django-oscar/django-oscar) ⭐ 6,627 | 🐛 164 | 🌐 Python | 📅 2026-09-10 - Domain-driven e-commerce for Django.
...
* [django-markdown-editor](https://github.com/agusmakmun/django-markdown-editor) ⭐ 901 | 🐛 40 | 🌐 JavaScript | 📅 2026-07-20 - Awesome Django Markdown Editor, supported for Bootstrap & Semantic-UI.
...
* [django-crispy-forms](https://github.com/django-crispy-forms/django-crispy-forms/) ⭐ 5,157 | 🐛 75 | 🌐 Python | 📅 2026-07-29 - DRY Django forms.
...
* [Weblate](https://github.com/WeblateOrg/weblate) ⭐ 6,060 | 🐛 500 | 🌐 Python | 📅 2026-09-10 - Weblate is a copylefted libre software web-based continuous localization system, used by over 2500 libre projects and companies in more than 165 countries.
* [django-filter](https://github.com/carltongibson/django-filter) ⭐ 4,685 | 🐛 92 | 🌐 Python | 📅 2026-07-15 - Powerful filters based on Django QuerySets.
...
* [django-modeltranslations](https://github.com/deschler/django-modeltranslation) ⭐ 1,482 | 🐛 130 | 🌐 Python | 📅 2026-09-07 -  Translates Django models using a registration approach.
...
* [django-anymail](https://github.com/anymail/django-anymail) ⭐ 1,899 | 🐛 13 | 🌐 Python | 📅 2026-09-05 - Django email backends and webhooks for Amazon SES, Brevo (Sendinblue), MailerSend, Mailgun, Mailjet, Postmark, Postal, Resend, SendGrid, SparkPost, Unisender Go and more.
...
* [django-taggit](https://github.com/jazzband/django-taggit/) ⭐ 3,447 | 🐛 115 | 🌐 Python | 📅 2026-08-24 - Simple model tags.
...
* [py-spy](https://github.com/benfred/py-spy) ⭐ 15,488 | 🐛 240 | 🌐 Rust | 📅 2026-08-14 - Sampling profiler for Python programs.
...
* [django-silk](https://github.com/jazzband/django-silk) ⭐ 4,993 | 🐛 128 | 🌐 Python | 📅 2026-09-10 - Live profiling and inspection of HTTP requests and database queries.
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,913 | 🐛 31 | 🌐 Python | 📅 2026-09-09 - Per object permissions in Django.
...
* [celery](https://github.com/celery/celery) ⭐ 28,874 | 🐛 729 | 🌐 Python | 📅 2026-09-10 - Robust and broker-agnostic task queues for bigger, performance-focused projects.
...
* [huey](https://github.com/coleifer/huey) ⭐ 6,032 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - A little task queue for Python, with Django support including the new `django.tasks` API.
* [django-redis](https://github.com/jazzband/django-redis) ⭐ 3,086 | 🐛 80 | 🌐 Python | 📅 2026-09-07 - Full-featured Redis cache backend for Django.
* [django-celery-beat](https://github.com/celery/django-celery-beat) ⭐ 1,953 | 🐛 154 | 🌐 Python | 📅 2026-09-07 - A periodic task scheduler with database configured by Django's Admin Panel.
* [django-rq](https://github.com/rq/django-rq) ⭐ 1,950 | 🐛 116 | 🌐 Python | 📅 2026-09-08 - Integration for Redis Queue.
...
* [django-absurd](https://github.com/lincolnloop/django-absurd) ⭐ 20 | 🐛 9 | 🌐 Python | 📅 2026-09-10 - Django integration for Absurd, a Postgres-native durable workflow system.
...
* [django-debug-toolbar](https://github.com/django-commons/django-debug-toolbar/) ⭐ 8,379 | 🐛 85 | 🌐 Python | 📅 2026-09-07 - Configurable panels to debug requests/responses.
* [factory-boy](https://github.com/FactoryBoy/factory_boy) ⭐ 3,806 | 🐛 211 | 🌐 Python | 📅 2026-01-01 - Test fixtures replacement.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,547 | 🐛 192 | 🌐 Python | 📅 2026-09-01 - Use pytest features in Django.
* [django-waffle](https://github.com/django-waffle/django-waffle) ⭐ 1,259 | 🐛 59 | 🌐 Python | 📅 2026-06-07 - A feature flipper for Django.
* [model-bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,003 | 🐛 11 | 🌐 Python | 📅 2026-09-08 - Object factory for Django (rename of legacy Model Mommy project).
...
* [django-allauth](https://github.com/pennersr/django-allauth/) ⭐ 10,379 | 🐛 2 | 🌐 Python | 📅 2026-09-01 - Improved user registration including social auth.
...
* [Ruff](https://github.com/astral-sh/ruff) ⭐ 49,569 | 🐛 2,188 | 🌐 Rust | 📅 2026-09-10 - An extremely fast Python linter and code formatter, written in Rust.
* [black](https://github.com/psf/black) ⭐ 41,841 | 🐛 310 | 🌐 Python | 📅 2026-09-04 - Uncompromising Python code formatter.
* [faker](https://github.com/joke2k/faker) ⭐ 19,397 | 🐛 27 | 🌐 Python | 📅 2026-09-01 - Faker is a Python package that generates fake data for you.
* [pytest](https://github.com/pytest-dev/pytest/) ⭐ 14,495 | 🐛 817 | 🌐 Python | 📅 2026-09-08 - Testing framework.
* [pillow](https://github.com/python-pillow/Pillow) ⭐ 13,808 | 🐛 155 | 🌐 Python | 📅 2026-09-10 - Python Imaging Library.
...
* [coveragepy](https://github.com/coveragepy/coveragepy) ⭐ 3,412 | 🐛 306 | 🌐 Python | 📅 2026-09-07 - Code coverage measurement.
...
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,202 | 🐛 351 | 🌐 Python | 📅 2026-09-10 - Error reporting SDK.
* [python-slugify](https://github.com/un33k/python-slugify) ⭐ 1,624 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - Returns unicode slugs.
...
* [Source Code](https://github.com/django/django/) ⭐ 90,352 | 🐛 500 | 🌐 Python | 📅 2026-09-08 - Hosted on GitHub.
...
* [Django Styleguide](https://github.com/HackSoftware/Django-Styleguide) ⭐ 6,288 | 🐛 5 | 🌐 Python | 📅 2025-09-25 - Styleguide for Django with best practices and examples.
...
* [cookiecutter-django](https://github.com/cookiecutter/cookiecutter-django/) ⭐ 13,608 | 🐛 103 | 🌐 Python | 📅 2026-09-10 - A full-bodied starter project, highly customizable.
...
* [PostHog](https://github.com/PostHog/posthog) ⭐ 39,729 | 🐛 5,444 | 🌐 Python | 📅 2026-09-10 - Open-source product analytics.
* [Zulip](https://github.com/zulip/zulip/) ⭐ 25,877 | 🐛 2,012 | 🌐 Python | 📅 2026-09-09 - Open-source team chat.
* [linkding](https://github.com/sissbruecker/linkding) ⭐ 11,161 | 🐛 220 | 🌐 Python | 📅 2026-09-10 - Self-hosted bookmark manager that is designed to be minimal, fast, and easy to set up using Docker.
...
* [Flagsmith](https://github.com/Flagsmith/flagsmith) ⭐ 6,543 | 🐛 708 | 🌐 Python | 📅 2026-09-10 - Open-source Feature Flagging, Remote Config, and AB testing.
* [Baserow](https://github.com/baserow/baserow) ⭐ 5,846 | 🐛 1,240 | 🌐 Python | 📅 2026-09-10 - Open source no-code database and Airtable alternative built with Django and Vue.js.
* [pretix](https://github.com/pretix/pretix) ⭐ 2,514 | 🐛 149 | 🌐 Python | 📅 2026-09-10 - Ticket shop application for conferences, festivals, concerts, and other events.
* [Bootcamp: An enterprise social network](https://github.com/vitorfs/bootcamp) ⭐ 2,302 | 🐛 25 | 🌐 CSS | 📅 2023-10-01
* [OpenContracts](https://github.com/Open-Source-Legal/OpenContracts) ⭐ 1,472 | 🐛 13 | 🌐 Python | 📅 2026-09-10 - Enterprise-grade document analytics platform that combines automated PDF parsing, vector embeddings, and LLM integration.
...
* [pretalx](https://github.com/pretalx/pretalx) ⭐ 940 | 🐛 55 | 🌐 Python | 📅 2026-09-10 - Conference planning tool for the call for papers, scheduling, and speaker management.
...
* [Django CRM Admin](https://github.com/DjangoCRM/django-crm) ⭐ 623 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - Open source Python CRM built entirely on Django Admin Site.
...
* [Revel](https://github.com/letsrevel/revel-backend) ⭐ 107 | 🐛 19 | 🌐 Python | 📅 2026-09-10 - Self-hostable event management and ticketing platform with organizations, questionnaire-based attendee screening, QR check-in, and Stripe payments.
...
* [DRF Source Code](https://github.com/encode/django-rest-framework) ⭐ 30,172 | 🐛 51 | 🌐 Python | 📅 2026-09-09
...
* [Wagtail Source Code](https://github.com/wagtail/wagtail/) ⭐ 20,492 | 🐛 1,007 | 🌐 Python | 📅 2026-09-10
