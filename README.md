...
* [django-unfold](https://github.com/unfoldadmin/django-unfold) ⭐ 3,673 | 🐛 35 | 🌐 Python | 📅 2026-09-13 - Modern Django admin theme for seamless interface development.
...
* [django-smartbase-admin](https://github.com/SmartBase-SK/django-smartbase-admin) ⭐ 129 | 🐛 2 | 🌐 Python | 📅 2026-09-11 - Django SmartBase Admin 🚀 performance-tuned 👥 end-user ready beautiful admin panel

### APIs

<!--lint disable double-link-->

* [django-rest-framework](https://github.com/encode/django-rest-framework) ⭐ 30,176 | 🐛 51 | 🌐 Python | 📅 2026-09-12 - Web APIs for Django.
...
* [django-rest-framework-simplejwt](https://github.com/jazzband/djangorestframework-simplejwt) ⭐ 4,332 | 🐛 160 | 🌐 Python | 📅 2026-09-07 - JSON web tokens for DRF.
...
* [drf-spectacular](https://github.com/tfranzel/drf-spectacular) ⭐ 2,860 | 🐛 212 | 🌐 Python | 📅 2026-09-02 - Sane and flexible OpenAPI 3 schema generation for Django REST framework.
...
* [django-modern-rest](https://github.com/wemake-services/django-modern-rest) ⭐ 1,451 | 🐛 49 | 🌐 Python | 📅 2026-09-13 - Modern REST with speed, types, async, `msgspec`, `pydantic` and other goodies!
* [django-rest-knox](https://github.com/jazzband/django-rest-knox) ⭐ 1,260 | 🐛 37 | 🌐 Python | 📅 2026-08-31 - Authentication Module for django-rest-auth.
* [strawberry-django](https://github.com/strawberry-graphql/strawberry-django) ⭐ 505 | 🐛 94 | 🌐 Python | 📅 2026-09-13 - Django integration with Strawberry, a GraphQL library designed for modern development
...
* [django-extensions](https://github.com/django-extensions/django-extensions/) ⭐ 6,809 | 🐛 221 | 🌐 Python | 📅 2026-08-31 - Custom management extensions, notably `runserver_plus` and `shell_plus`.
...
* [wagtail](https://github.com/wagtail/wagtail) ⭐ 20,497 | 🐛 1,004 | 🌐 Python | 📅 2026-09-10 - Popular Django content management system (CMS). See [awesome-wagtail](https://github.com/wagtail/awesome-wagtail) ⭐ 2,188 | 🐛 1 | 🌐 Python | 📅 2026-06-16 too.
* [django-cms](https://github.com/django-cms/django-cms) ⭐ 10,667 | 🐛 7 | 🌐 Python | 📅 2026-09-12 - CMS for Django.
...
* [saleor](https://github.com/saleor/saleor) ⭐ 23,325 | 🐛 262 | 🌐 Python | 📅 2026-09-11 - GraphQL-based Django E-Commerce Platform.
* [django-oscar](https://github.com/django-oscar/django-oscar) ⭐ 6,629 | 🐛 156 | 🌐 Python | 📅 2026-09-11 - Domain-driven e-commerce for Django.
...
* [sorl-thumbnail](https://github.com/jazzband/sorl-thumbnail) ⭐ 1,796 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - Thumbnails for Django.
...
* [Weblate](https://github.com/WeblateOrg/weblate) ⭐ 6,062 | 🐛 499 | 🌐 Python | 📅 2026-09-13 - Weblate is a copylefted libre software web-based continuous localization system, used by over 2500 libre projects and companies in more than 165 countries.
...
* [django-anymail](https://github.com/anymail/django-anymail) ⭐ 1,899 | 🐛 12 | 🌐 Python | 📅 2026-09-12 - Django email backends and webhooks for Amazon SES, Brevo (Sendinblue), MailerSend, Mailgun, Mailjet, Postmark, Postal, Resend, SendGrid, SparkPost, Unisender Go and more.
...
* [py-spy](https://github.com/benfred/py-spy) ⭐ 15,494 | 🐛 240 | 🌐 Rust | 📅 2026-08-14 - Sampling profiler for Python programs.
...
* [celery](https://github.com/celery/celery) ⭐ 28,876 | 🐛 720 | 🌐 Python | 📅 2026-09-13 - Robust and broker-agnostic task queues for bigger, performance-focused projects.
...
* [django-redis](https://github.com/jazzband/django-redis) ⭐ 3,085 | 🐛 80 | 🌐 Python | 📅 2026-09-07 - Full-featured Redis cache backend for Django.
* [django-celery-beat](https://github.com/celery/django-celery-beat) ⭐ 1,953 | 🐛 152 | 🌐 Python | 📅 2026-09-12 - A periodic task scheduler with database configured by Django's Admin Panel.
...
* [django-ox](https://github.com/oxpull/django-ox) ⭐ 92 | 🐛 4 | 🌐 Python | 📅 2026-09-13 - Database-backed worker for Django's Tasks framework, with transactional enqueue, retries, recurring tasks, and no broker to run.
* [django-absurd](https://github.com/lincolnloop/django-absurd) ⭐ 33 | 🐛 9 | 🌐 Python | 📅 2026-09-11 - Django integration for Absurd, a Postgres-native durable workflow system.
...
* [django-template-partials](https://github.com/carltongibson/django-template-partials/) ⭐ 654 | 🐛 1 | 🌐 Python | 📅 2025-11-20 - Reusable named inline partials for the Django Template Language.
...
* [django-debug-toolbar](https://github.com/django-commons/django-debug-toolbar/) ⭐ 8,379 | 🐛 80 | 🌐 Python | 📅 2026-09-13 - Configurable panels to debug requests/responses.
...
* [model-bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,003 | 🐛 12 | 🌐 Python | 📅 2026-09-12 - Object factory for Django (rename of legacy Model Mommy project).
...
* [Ruff](https://github.com/astral-sh/ruff) ⭐ 49,617 | 🐛 2,198 | 🌐 Rust | 📅 2026-09-13 - An extremely fast Python linter and code formatter, written in Rust.
* [black](https://github.com/psf/black) ⭐ 41,840 | 🐛 316 | 🌐 Python | 📅 2026-09-11 - Uncompromising Python code formatter.
...
* [pytest](https://github.com/pytest-dev/pytest/) ⭐ 14,501 | 🐛 826 | 🌐 Python | 📅 2026-09-13 - Testing framework.
* [pillow](https://github.com/python-pillow/Pillow) ⭐ 13,808 | 🐛 156 | 🌐 Python | 📅 2026-09-13 - Python Imaging Library.
...
* [coveragepy](https://github.com/coveragepy/coveragepy) ⭐ 3,411 | 🐛 307 | 🌐 Python | 📅 2026-09-13 - Code coverage measurement.
...
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,201 | 🐛 363 | 🌐 Python | 📅 2026-09-11 - Error reporting SDK.
...
* [Source Code](https://github.com/django/django/) ⭐ 90,763 | 🐛 503 | 🌐 Python | 📅 2026-09-08 - Hosted on GitHub.
...
* [Django Styleguide](https://github.com/HackSoftware/Django-Styleguide) ⭐ 6,290 | 🐛 5 | 🌐 Python | 📅 2025-09-25 - Styleguide for Django with best practices and examples.
...
* [cookiecutter-django](https://github.com/cookiecutter/cookiecutter-django/) ⭐ 13,607 | 🐛 105 | 🌐 Python | 📅 2026-09-11 - A full-bodied starter project, highly customizable.
...
* [django-base-site](https://github.com/epicserve/django-base-site/) ⭐ 451 | 🐛 2 | 🌐 Python | 📅 2026-09-12 - A Django site with many common third-party packages pre-installed.
...
* [PostHog](https://github.com/PostHog/posthog) ⭐ 39,770 | 🐛 5,599 | 🌐 Python | 📅 2026-09-13 - Open-source product analytics.
* [Zulip](https://github.com/zulip/zulip/) ⭐ 25,888 | 🐛 2,011 | 🌐 Python | 📅 2026-09-11 - Open-source team chat.
* [linkding](https://github.com/sissbruecker/linkding) ⭐ 11,166 | 🐛 207 | 🌐 Python | 📅 2026-09-12 - Self-hosted bookmark manager that is designed to be minimal, fast, and easy to set up using Docker.
* [Healthchecks](https://github.com/healthchecks/healthchecks) ⭐ 10,327 | 🐛 53 | 🌐 Python | 📅 2026-09-10 - A Cron Monitoring Tool written in Python & Django.
* [Flagsmith](https://github.com/Flagsmith/flagsmith) ⭐ 6,549 | 🐛 707 | 🌐 Python | 📅 2026-09-12 - Open-source Feature Flagging, Remote Config, and AB testing.
* [Baserow](https://github.com/baserow/baserow) ⭐ 5,863 | 🐛 1,241 | 🌐 Python | 📅 2026-09-12 - Open source no-code database and Airtable alternative built with Django and Vue.js.
...
* [pretalx](https://github.com/pretalx/pretalx) ⭐ 942 | 🐛 52 | 🌐 Python | 📅 2026-09-13 - Conference planning tool for the call for papers, scheduling, and speaker management.
* [Django CRM Admin](https://github.com/DjangoCRM/django-crm) ⭐ 625 | 🐛 2 | 🌐 Python | 📅 2026-09-12 - Open source Python CRM built entirely on Django Admin Site.
...
* [venueless](https://github.com/venueless/venueless) ⭐ 225 | 🐛 96 | 🌐 Python | 📅 2026-09-13 - Platform for online and hybrid events with live streams, chat, and video rooms, from the pretix team.
...
* [DRF Source Code](https://github.com/encode/django-rest-framework) ⭐ 30,176 | 🐛 51 | 🌐 Python | 📅 2026-09-12
