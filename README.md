...
* [django-rest-framework](https://github.com/encode/django-rest-framework) ⭐ 30,178 | 🐛 52 | 🌐 Python | 📅 2026-09-14 - Web APIs for Django.
...
* [django-rest-framework-simplejwt](https://github.com/jazzband/djangorestframework-simplejwt) ⭐ 4,331 | 🐛 160 | 🌐 Python | 📅 2026-09-07 - JSON web tokens for DRF.
...
* [django-modern-rest](https://github.com/wemake-services/django-modern-rest) ⭐ 1,454 | 🐛 48 | 🌐 Python | 📅 2026-09-14 - Modern REST with speed, types, async, `msgspec`, `pydantic` and other goodies!
...
* [strawberry-django](https://github.com/strawberry-graphql/strawberry-django) ⭐ 504 | 🐛 94 | 🌐 Python | 📅 2026-09-13 - Django integration with Strawberry, a GraphQL library designed for modern development
...
* [wagtail](https://github.com/wagtail/wagtail) ⭐ 20,497 | 🐛 1,005 | 🌐 Python | 📅 2026-09-14 - Popular Django content management system (CMS). See [awesome-wagtail](https://github.com/wagtail/awesome-wagtail) ⭐ 2,188 | 🐛 1 | 🌐 Python | 📅 2026-06-16 too.
* [django-cms](https://github.com/django-cms/django-cms) ⭐ 10,666 | 🐛 9 | 🌐 Python | 📅 2026-09-14 - CMS for Django.
* [mezzanine](https://github.com/stephenmcd/mezzanine) ⭐ 4,817 | 🐛 65 | 🌐 Python | 📅 2026-04-19 - CMS framework.
* [feincms](https://github.com/feincms/feincms) ⭐ 1,118 | 🐛 25 | 🌐 Python | 📅 2026-09-07 - An extensible Django-based CMS.
...
* [saleor](https://github.com/saleor/saleor) ⭐ 23,327 | 🐛 259 | 🌐 Python | 📅 2026-09-14 - GraphQL-based Django E-Commerce Platform.
...
* [ReactPy](https://github.com/reactive-python/reactpy) ⭐ 8,150 | 🐛 51 | 🌐 Python | 📅 2026-07-14 - It's React, but in Python. Insert dynamically rendered Python into Django templates using the [ReactPy-Django module](https://github.com/reactive-python/reactpy-django) ⭐ 357 | 🐛 17 | 🌐 Python | 📅 2026-09-14.
...
* [Weblate](https://github.com/WeblateOrg/weblate) ⭐ 6,062 | 🐛 501 | 🌐 Python | 📅 2026-09-14 - Weblate is a copylefted libre software web-based continuous localization system, used by over 2500 libre projects and companies in more than 165 countries.
...
* [django-anymail](https://github.com/anymail/django-anymail) ⭐ 1,898 | 🐛 12 | 🌐 Python | 📅 2026-09-12 - Django email backends and webhooks for Amazon SES, Brevo (Sendinblue), MailerSend, Mailgun, Mailjet, Postmark, Postal, Resend, SendGrid, SparkPost, Unisender Go and more.
...
* [django-simple-history](https://github.com/django-commons/django-simple-history) ⭐ 2,464 | 🐛 197 | 🌐 Python | 📅 2026-09-04 - Store model history and view/revert changes from the admin.
...
* [py-spy](https://github.com/benfred/py-spy) ⭐ 15,499 | 🐛 240 | 🌐 Rust | 📅 2026-08-14 - Sampling profiler for Python programs.
* [pyinstrument](https://github.com/joerick/pyinstrument) ⭐ 8,007 | 🐛 30 | 🌐 Python | 📅 2026-09-01 - Call stack profiler for Python, Django, Flask, FastAPI.
...
* [django-guardian](https://github.com/django-guardian/django-guardian) ⭐ 3,913 | 🐛 32 | 🌐 Python | 📅 2026-09-12 - Per object permissions in Django.
...
* [celery](https://github.com/celery/celery) ⭐ 28,884 | 🐛 719 | 🌐 Python | 📅 2026-09-13 - Robust and broker-agnostic task queues for bigger, performance-focused projects.
...
* [huey](https://github.com/coleifer/huey) ⭐ 6,034 | 🐛 0 | 🌐 Python | 📅 2026-09-13 - A little task queue for Python, with Django support including the new `django.tasks` API.
...
* [django-ox](https://github.com/oxpull/django-ox) ⭐ 92 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - Database-backed worker for Django's Tasks framework, with transactional enqueue, retries, recurring tasks, and no broker to run.
* [django-absurd](https://github.com/lincolnloop/django-absurd) ⭐ 34 | 🐛 9 | 🌐 Python | 📅 2026-09-11 - Django integration for Absurd, a Postgres-native durable workflow system.
...
* [django-test-migrations](https://github.com/wemake-services/django-test-migrations) ⭐ 575 | 🐛 15 | 🌐 Python | 📅 2026-09-11 - Test django schema and data migrations, including migrations' order.
...
* [django-allauth](https://github.com/pennersr/django-allauth/) ⭐ 10,377 | 🐛 2 | 🌐 Python | 📅 2026-09-11 - Improved user registration including social auth.
...
* [Ruff](https://github.com/astral-sh/ruff) ⭐ 49,628 | 🐛 2,198 | 🌐 Rust | 📅 2026-09-14 - An extremely fast Python linter and code formatter, written in Rust.
* [black](https://github.com/psf/black) ⭐ 41,841 | 🐛 322 | 🌐 Python | 📅 2026-09-11 - Uncompromising Python code formatter.
* [faker](https://github.com/joke2k/faker) ⭐ 19,400 | 🐛 29 | 🌐 Python | 📅 2026-09-01 - Faker is a Python package that generates fake data for you.
* [pytest](https://github.com/pytest-dev/pytest/) ⭐ 14,505 | 🐛 811 | 🌐 Python | 📅 2026-09-14 - Testing framework.
* [pillow](https://github.com/python-pillow/Pillow) ⭐ 13,810 | 🐛 154 | 🌐 Python | 📅 2026-09-14 - Python Imaging Library.
...
* [sentry-python](https://github.com/getsentry/sentry-python) ⭐ 2,202 | 🐛 363 | 🌐 Python | 📅 2026-09-14 - Error reporting SDK.
...
* [Source Code](https://github.com/django/django/) ⭐ 91,063 | 🐛 504 | 🌐 Python | 📅 2026-09-08 - Hosted on GitHub.
...
* [cookiecutter-django](https://github.com/cookiecutter/cookiecutter-django/) ⭐ 13,606 | 🐛 99 | 🌐 Python | 📅 2026-09-14 - A full-bodied starter project, highly customizable.
...
* [PostHog](https://github.com/PostHog/posthog) ⭐ 39,787 | 🐛 5,599 | 🌐 Python | 📅 2026-09-14 - Open-source product analytics.
* [Zulip](https://github.com/zulip/zulip/) ⭐ 25,900 | 🐛 2,011 | 🌐 Python | 📅 2026-09-11 - Open-source team chat.
* [linkding](https://github.com/sissbruecker/linkding) ⭐ 11,170 | 🐛 206 | 🌐 Python | 📅 2026-09-13 - Self-hosted bookmark manager that is designed to be minimal, fast, and easy to set up using Docker.
* [Healthchecks](https://github.com/healthchecks/healthchecks) ⭐ 10,326 | 🐛 53 | 🌐 Python | 📅 2026-09-14 - A Cron Monitoring Tool written in Python & Django.
* [Flagsmith](https://github.com/Flagsmith/flagsmith) ⭐ 6,550 | 🐛 713 | 🌐 Python | 📅 2026-09-14 - Open-source Feature Flagging, Remote Config, and AB testing.
* [Baserow](https://github.com/baserow/baserow) ⭐ 5,887 | 🐛 1,239 | 🌐 Python | 📅 2026-09-14 - Open source no-code database and Airtable alternative built with Django and Vue.js.
* [pretix](https://github.com/pretix/pretix) ⭐ 2,516 | 🐛 146 | 🌐 Python | 📅 2026-09-14 - Ticket shop application for conferences, festivals, concerts, and other events.
* [Bootcamp: An enterprise social network](https://github.com/vitorfs/bootcamp) ⭐ 2,300 | 🐛 25 | 🌐 CSS | 📅 2023-10-01
* [OpenContracts](https://github.com/Open-Source-Legal/OpenContracts) ⭐ 1,475 | 🐛 27 | 🌐 Python | 📅 2026-09-14 - Enterprise-grade document analytics platform that combines automated PDF parsing, vector embeddings, and LLM integration.
...
* [pretalx](https://github.com/pretalx/pretalx) ⭐ 942 | 🐛 52 | 🌐 Python | 📅 2026-09-14 - Conference planning tool for the call for papers, scheduling, and speaker management.
* [Django CRM Admin](https://github.com/DjangoCRM/django-crm) ⭐ 626 | 🐛 4 | 🌐 Python | 📅 2026-09-14 - Open source Python CRM built entirely on Django Admin Site.
...
* [Revel](https://github.com/letsrevel/revel-backend) ⭐ 107 | 🐛 20 | 🌐 Python | 📅 2026-09-14 - Self-hostable event management and ticketing platform with organizations, questionnaire-based attendee screening, QR check-in, and Stripe payments.
...
* [DRF Source Code](https://github.com/encode/django-rest-framework) ⭐ 30,178 | 🐛 52 | 🌐 Python | 📅 2026-09-14
...
* [Wagtail Source Code](https://github.com/wagtail/wagtail/) ⭐ 20,497 | 🐛 1,005 | 🌐 Python | 📅 2026-09-14
