...
* [django-admin-mcp](https://github.com/7tg/django-admin-mcp) ⭐ 21 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - Expose admin-registered models to MCP clients (AI assistants like Claude): CRUD, admin actions, and history through your ModelAdmin classes, capped by Django permissions.
...
* [django-unfold](https://github.com/unfoldadmin/django-unfold) ⭐ 3,686 | 🐛 21 | 🌐 Python | 📅 2026-09-25 - Modern Django admin theme for seamless interface development.
...
* [django-cachalot](https://github.com/noripyt/django-cachalot) ⭐ 1,433 | 🐛 34 | 🌐 Python | 📅 2026-08-10 - Caches your Django ORM queries and automatically invalidates them.
...
* [sorl-thumbnail](https://github.com/jazzband/sorl-thumbnail) ⭐ 1,794 | 🐛 5 | 🌐 Python | 📅 2026-09-21 - Thumbnails for Django.
...
* [py-spy](https://github.com/benfred/py-spy) ⭐ 15,517 | 🐛 244 | 🌐 Rust | 📅 2026-08-14 - Sampling profiler for Python programs.
